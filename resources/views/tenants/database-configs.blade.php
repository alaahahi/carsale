...
@section('title', 'إعدادات قاعدة البيانات للمستأجر')
        ...
        <div class="col-12">
            <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 rounded-lg shadow-lg">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-3xl font-bold mb-2">إعدادات قاعدة البيانات</h1>
                        <p class="text-blue-100">إدارة إعدادات قاعدة البيانات للمستأجر: {{ $tenant->name }}</p>
                    </div>
                    <div class="flex space-x-4">
                        <a href="{{ route('tenants.create-database-config', $tenant->id) }}" 
                        ...
                        <a href="{{ route('tenants.show', $tenant->id) }}" 
                           class="bg-gray-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-600 transition-colors">
                            <i class="fas fa-arrow-right mr-2"></i>العودة للمستأجر
                        </a>
                    </div>
                </div>
            </div>
